...
pub async fn get_me(
    ...
    let me = app.profile_service.get_me(auth_user.id).await?;
...
pub async fn get_profile(
    ...
    let user = app.profile_service.get_user_by_id(auth_user.id, id).await?;
...
pub async fn update_me(
    ...
    body.validate()?;
    let me = app.profile_service.update_me(auth_user.id, &body).await?;
